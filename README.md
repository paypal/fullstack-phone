...
| ---------------------------------------- | ---------------------------------------- | ---------------------------------------- | ---------------------------------------- |
| [![Build Status](https://travis-ci.org/paypal/fullstack-phone.svg?branch=master)](https://travis-ci.org/paypal/fullstack-phone) | [![Build Status](https://travis-ci.org/paypal/fullstack-phone.svg?branch=develop)](https://travis-ci.org/paypal/fullstack-phone) | [![npm version](https://badge.fury.io/js/fullstack-phone.svg)](https://www.npmjs.com/package/fullstack-phone) | [v8.9.15](https://github.com/googlei18n/libphonenumber/blob/master/release_notes.txt) |
